            ...
            <div className="cntnr w-full h-[80%] text-white flex">
              <div className="limg w-1/2 h-full relative">
                <img
                  ...
                  alt="man sitting"
                />
                <img className="absolute scale-[65%] top-1/2 left-[68%] -translate-x-1/2 -translate-y-1/2" src="./women_sitting.png" alt="women sitting" />
              </div>
              <div className="rimg w-[40%] py-20">
                <h1 className="text-6xl">Still Running,</h1>
                <h1 className="text-6xl">Not Hunting</h1>
                <p className="text-xl mt-15 font-[Helvatica_now_Display]">
                  GTA 6 is a role-playing video game developed by Rockstar
                  North and published by Rockstar Games. It is the seventh
                  main entry in the Grand Theft Auto series and a prequel to
                ...
                <p className="text-xl mt-5 font-[Helvatica_now_Display]">
                  ...
                  which is a vast and complex open world. Players can
                  explore the city, complete missions, and interact with
                  various characters.
                </p>
                <p className="text-xl mt-10 font-[Helvatica_now_Display]">
                  Players can customize their characters, buy and sell
                  vehicles, and engage in various activities. The game
                  features a rich and detailed world, with a vast array of
                  locations to explore.
                </p>
                <button className="bg-yellow-500 text-black px-8 py-7 text-3xl rounded-md mt-10">Download Now</button>
              </div>
            </div>
          </div>
        </div>
